...
var shareData = {
    title:"今年中秋，你凑得齐全家福吗？",
    desc: "中秋团圆，家人相聚不易，来动动手指把大家庭里的每一个人凝聚在一起吧！",
    link: window.location.href,
    imgUrl: "http://mat1.gtimg.com/zj/yuwanli/dzw1609/photo/images/share_img.jpg"
};
...
function shoot(){
    ...
    var photo1 = bmd1.copy(bmd_draw, (winWidth-rectangleWidth)/2, toTop-(rectangleWidth-rectangleHeight)/2, rectangleWidth, rectangleWidth,0,0, 300, 300);
    ...
    if(count == 7&&!moveFlag){
        ...
        shareData.title = "终于抓住乱跑的熊孩子了！拍摄全家福太不容易了！";
    }else{
        $('.page1').addClass("failed");
        shareData.desc = "家里人聚齐实在太困难了！熊孩子总乱跑，臣妾抓不到啊！！！";
    }
    resetWXshare();
}
function RndNum(n){
...
var wxShareInit = function(callback){
    if(typeof callback !== 'function'){
        callback = function(){};
    }
    var url = window.location.href;
    if(isWechat()){
        ajax('GET',"http://vip.zjqq.mobi/plugin/send.php?url="+url,'',function(data){
            wx.config({
                debug: true,
                appId: data.appId,
