...
function shoot(){
    ...
    var photo1 = bmd1.copy(bmd_draw, (winWidth-rectangleWidth)/2, toTop-(rectangleWidth-rectangleHeight)/2, rectangleWidth, rectangleWidth,0,0, rectangleWidth/2, rectangleWidth/2);
